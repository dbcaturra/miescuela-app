...
public class MainMenuActivity extends AppCompatActivity {
    ...
    public void onPressedSelect(View v) {
        Log.d(TAG, "[APRENDER] pressed");
        // Create a new Intent object
        Intent i = new Intent(this, MiescuelakoalaActivity.class);
        // Start our GameActivity class via the Intent
        startActivity(i);
    }

    public void onPressedScores(View v) {
        Log.d(TAG, "[STREAMMING] pressed");
        // Create a new Intent object
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                //if user entered nothing, remprompt for username
                                    ...
                                    makeAlertWithConfirmedConnection("Por favor entre un nombre de usuario", resetting);
                                }
                            }
